...
describe('Potions', () => {
  describe('value', () => {
    ...
    it('Should have the same value as the passed blueprint rounded with no extra cost', () => {
      expect(
        new Potion({
    ...
    it('Should add the cost of consumed components added when appropriated', () => {
      expect(
        new Potion({
          blueprint: new PotionBlueprint({ effectLevels: [1, 2, 4], sideEffectCategories: ['strong', 'very_weak'], }),
          effects: [
            new PotionEffect({level: 1, component_consumed_cost: 50}),
            new PotionEffect({level: 2, component_consumed_cost: 100}),
    ...
    it('Should have the combined value of the cost of constant components', () => {
      expect(
        new Potion({
          blueprint: new PotionBlueprint({ effectLevels: [1, 2, 4], sideEffectCategories: ['strong', 'very_weak'], }),
          effects: [
            new PotionEffect({ level: 1, component_consumed_cost: 50, component_constant_cost: 100 }),
            new PotionEffect({ level: 2, component_consumed_cost: 100, component_constant_cost: 200 }),
            new PotionEffect({ level: 4, }),
          ],
        }).componentConstantCost
      ).toBe(300);
    });
  });
  ...
  describe('stringify', () => {
    it('Should return a string representing the potion', () => {
      ...
      ).toBe("{\"effects\":[{\"id\":\"effect_id_1\",\"level\":1,\"name\":\"effect_name_1\",\"description\":\"effect_description_1\",\"componentConstantCost\":0,\"componentConsumedCost\":0,\"reference\":null},{\"id\":\"effect_id_2\",\"level\":3,\"name\":\"effect_name_2\",\"description\":\"effect_description_2\",\"componentConstantCost\":0,\"componentConsumedCost\":0,\"reference\":null}],\"sideEffects\":[{\"id\":\"side_effect_1\",\"category\":\"medium\",\"type\":null,\"name\":\"side_effect_name_1\",\"adjective\":\"side_effect_name_1\",\"incompatibleWith\":[]},{\"id\":\"side_effect_2\",\"category\":\"very_strong\",\"type\":null,\"name\":\"side_effect_name_2\",\"adjective\":\"side_effect_name_2\",\"incompatibleWith\":[]}],\"blueprint\":{\"effectLevels\":[1],\"sideEffectCategories\":[\"medium\",\"very_strong\"]},\"name\":\"Test Potion\",\"description\":\"Test Description\",\"image\":\"Test Image\"}");
    });
  });
